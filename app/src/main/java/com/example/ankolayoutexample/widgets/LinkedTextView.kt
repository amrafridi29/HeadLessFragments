...
class LinkedTextView(context: Context, attrs: AttributeSet) : TextView(context, attrs) {

    private var onLinkClickListener: ((url: String) -> Unit)? = null
    private var attributes: TypedArray =
        context.obtainStyledAttributes(attrs, R.styleable.LinkedTextView, 0, 0)

    init {

        val linkText = attributes.getString(R.styleable.LinkedTextView_link_text)
